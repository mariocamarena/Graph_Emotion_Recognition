...
# get data list
trnlist, trnlb = get_datalist(data_path='C:/Users/Mario/OneDrive/Desktop/gcn/graph_emotionv1/test/archive/', path='C:/Users/Mario/OneDrive/Desktop/gcn/graph_emotionv1/preprocess/RMLT.txt')
...
# Save Graph data
np.save('22train_graph_data_RML.npy', Graph_train_data[1:])
np.save('22train_graph_label_RML.npy', train_label[1:])