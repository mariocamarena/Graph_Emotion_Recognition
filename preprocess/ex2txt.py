...
with open("C:/Users/Mario/OneDrive/Desktop/gcn/graph_emotionv1/CARLA_Data/keys/customIDSvR.txt", 'w') as f:
    ...
    for index, row in df.iterrows():
        ...
        new_first_col = f"C:/Users/Mario/OneDrive/Desktop/gcn/graph_emotionv1/CARLA_Data/subject_screenshots/subject_{subject_num}/{row[0]}"
