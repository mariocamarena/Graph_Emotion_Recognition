...
# get data list
trnlist, trnlb = get_datalist(data_path='C:/Users/Mario/OneDrive/Desktop/gcn/graph_emotionv1/test/avi_files3/', path='C:/Users/Mario/OneDrive/Desktop/gcn/graph_emotionv1/preprocess/RML6.txt')
...
# Save Graph data
np.save('1train_graph_data_RML.npy', Graph_train_data[1:])
np.save('1train_graph_label_RML.npy', train_label[1:])